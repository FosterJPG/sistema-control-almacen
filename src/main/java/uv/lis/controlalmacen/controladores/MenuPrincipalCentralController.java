...
public class MenuPrincipalCentralController implements Initializable, MenuController {
    ...
    @FXML private void clicEncargados(ActionEvent e) { navegarA("CatalogoEncargados",      "Gestión de Encargados"); }
    ...
    @FXML private void clicDepartamentos(ActionEvent e) { navegarA("CatalogoDepartamentos", "Catálogo de Departamentos"); }
